...
velocidade = 61 # velocidad atual do carro
...
if velocidade_carro_passou_radar_1:
  print(f'Velocidade carro passou radar 1 {velocidade} km/h')
...
if carro_multado_radar_1:
  ...
  print(f'Você não foi multado passou abaixo da velocidade {velocidade} km/h')